  ...
  return (
    <div className="App">
      <Helmet>
        ...
        <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
        <link
          href="https://fonts.googleapis.com/css2?family=Cabin+Sketch:wght@700&family=Courgette&family=Exo+2:wght@500&family=Fredericka+the+Great&family=Lora:wght@500&family=Merriweather&family=Playfair+Display+SC:wght@700&family=Playfair+Display:wght@800&family=Poppins&display=swap"
          rel="stylesheet"
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Abril+Fatface&family=Alegreya:wght@500&family=Barlow+Condensed:wght@500&family=EB+Garamond:wght@400;500&family=Great+Vibes&family=Josefin+Slab:wght@600&family=Montserrat&family=Oswald&family=Playfair+Display+SC&family=Playfair+Display:wght@800&family=Trirong:wght@600&display=swap"
          rel="stylesheet"
        />
      </Helmet>
      <TopNavbar />
